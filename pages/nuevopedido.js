...
const NuevoPedido = () => {
  ...
  const {cliente, productos, total, fecha, actualizarStockProductos} = pedidoContext;
  ...
  const crearNuevoPedido = async ()=>{
    ...
    try{
      ...
      await productos.map(producto=>{
        actualizarStockProductos({id : producto.id , cantidad : producto.cantidad})
      })
      console.log("PRODUCTOS TOTAL", productos)
      //redireccionar
      router.push('/pedidos')
      Swal.fire(
        "Correcto",
